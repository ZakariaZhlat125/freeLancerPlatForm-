...
@section('content')
    ...
    <div class="container pt-20">
                                ...
                                <div class="row my-5 grid place-items-center">
                                    <div class="col-md-8 col-sm-12">
                                        <div class="card shadow-sm ">
                                            ...
                                            <div class="card-body">
                                                <form action="{{ route('works.saveUserWork') }}" method="POST"
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="col-sm-10">
                    <input type="text"
                        ...
                        id="" value="{{ $data->title ?? old('title') }}" name="title">
                </div>
                @error('title')
            ...
            <div class="col-md-6">
                ...
                <div class="col-sm-10">
                    <input type="date"
                        class="appearance-none block w-full bg-sacondary-light-white-pinky border-primary-light-pink border-sm text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-primary-pink"
                        id="" value="{{ $data->comple_date ?? old('comple_date') }}" name="comple_date"
                        value="">
                </div>
                @error('comple_date')
                    <div id='alert ' class="   px-4 alert position-fixed  alert-warning" role="alert"
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="col-sm-10">
                    <input type="file"
                        class="appearance-none block w-full bg-sacondary-light-white-pinky border-primary-light-pink border-sm text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-primary-pink"
                        id="" value="{{ $data->main_image ?? old('main_image') }}" name="main_image"
                        value="">
                </div>
                @error('main_image')
                    <div id='alert ' class="   px-4 alert position-fixed  alert-warning" role="alert"
            ...
            <div class="col-md-6">
                ...
                <div class="col-sm-10">
                    <input type="url"
                        class="appearance-none block w-full bg-sacondary-light-white-pinky border-primary-light-pink border-sm text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-primary-pink"
                        id="" value="{{ $data->link ?? old('link') }}" name="link" value="">
                </div>
                @error('link')
                    <div id='alert ' class="   px-4 alert position-fixed  alert-warning" role="alert"
                        style="width: fit-content; position: fixed; top: 20% ; right: 0px ; z-index: 9999999">
        ...
        <div class="col-md-11" style="margin-right:1px;">
            ...
            <textarea
                class=" appearance-none block w-full bg-sacondary-light-white-pinky border-primary-light-pink border-sm text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-primary-pink"
                placeholder=" تفاصيل العمل" id="" name="details">{{ $data->details ?? old('details') }}</textarea>
            @error('details')
                <div id='alert ' class="   px-4 alert position-fixed  alert-warning" role="alert"
                    style="width: fit-content; position: fixed; top: 20% ; right: 0px ; z-index: 9999999">
                    {{ $message }}
    ...
    @enderror
        ...
        <div class="row ">
            <div class="col-md-6 my-2">
                ...
                <select class="selectpicker col-md-6 " value="بالاختيار" name="skills[]" multiple
                    aria-label="size 2 select example" data-actions-box="true">
                    @foreach ($skills as $item)
                        <option id='skills' value="{{ $item->id }}" autocomplete="off">{{ $item->name }}
                        </option>
                    @endforeach
                </select>
