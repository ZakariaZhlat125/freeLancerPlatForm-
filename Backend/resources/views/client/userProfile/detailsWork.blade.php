                    ...
                    <div class=" float-start">
                        <a tabindex="-1" href="{{ route('edit_work', $item->id) }}">
                            <button class="mo-btn btn-blue-bg font-md">
                                {{ __('static.edit_button') }}
                            </button> </a>

                        <a tabindex="-1" data-bs-toggle="modal" data-bs-target="#deleteModel">

                            <button class="mo-btn btn-pink-bg pink font-md">
                                {{ __('static.delete_button') }}
                            </button>
                        </a>
                ...
                <div class="col-md-4 col-sm-12 my-2">
                    <div class="card shadow-sm pr-4 py-1 ">
                        <div class="pt-3 pb-2 " style="border-bottom: 1px solid var(--bg-main-bg)">
                            <h5 class="font-md mx-4" style="color:#373483;">
                                {{ __('static.work_Card') }}
                            </h5>
                        </div>
                        <div class="row p-3">
                            ...
                            <div class="px-2">
                                <span class="px-1 font-md ">
                                    {{ __('static.work_freelancer') }}
                                </span>
                            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{ route('toggle_work', $item->id) }}" class="mo-btn btn-pink-bg pink font-md">تاك
