                        ...
                        <div class="entry cursor-pointer transform hover:scale-105 duration-300 transition-transform bg-white mb-4 rounded p-4 flex shadow-md"
                            ...
                            <div class="flex-2">
                                <div class="w-12 h-12 relative">
                                    <img class="w-12 h-12 rounded-full mx-auto" src="/images/1651959757_edait.png"
                                        alt="chat-user" />
                                    @if ($user->is_online)
                                        <span
                            ...
                            <div class="flex-1 px-2">
                                ...
                                <div>
                                    <small class="text-gray">{{ $user->last_activity }}</small>
                                </div>
                                @if (filled($not_seen))
            ...
            <form  method="POST" action="{{ route('sendMessage', $sender) }}" >
                ...
                <div class="write bg-white shadow flex rounded-lg">
                    ...
                    <div class="flex-2 w-32 p-2 flex content-center items-center">
                        ...
                        @endif
                        <div class="flex-1">
                            <button type="submit" class="bg-blue-400 w-10 h-10 rounded-full inline-block">
